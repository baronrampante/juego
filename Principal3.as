package 
{
	...
	*/
	...
	public class Principal3 extends MovieClip
	{
		...
		public function init():void
		{
			...
			//carga peli externa
			peli = new URLRequest("cortar_tronco.swf");*/
		...
		public function Botones(evt:Event):void
		{
			...
			if (Cliente_Stage == true )
			{
				...
				Mormon1.globito.addEventListener(MouseEvent.MOUSE_DOWN, fnPlaca_Cliente);
			}
...
// para ver la cantidad de material existente
			...
			if (avance == _timer.currentCount)
			{
				...
				Trabajo_Que_se_Procesa.splice([0], 3);
		...
		public function fnBuscar_Trabajo()
		{
			...
			for (var i:uint=0; i<length; i++)
			{
				...
				{
					trace(String(Trabajos_Terminados_Entrega[i + 2]) + " venite a buscar el laburo");
		...
		function fnTexto_Pedido():void
		{
			...
			/*function descargaSeccion(event:Event):void
			{
			   ...
			   Mormon1.addEventListener("descargar",descargar);
			}*/
			...
			Mormon1.Velocidad_var = 20;
			addChild(Mormon1);
			Mormon1.gotoAndPlay("frente");
			Mormon1.adelante = true;
			Mormon1.x=200;
			Mormon1.y=400;
